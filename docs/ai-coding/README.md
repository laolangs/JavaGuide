...
5. [AI 编程必备 Skills 推荐](./practices/programmer-essential-skills.md)、[draw.io 绘图 Skill](./practices/drawio-chart-skill.md)、[OpenAI Codex 最佳实践指南](./practices/codex-best-practices.md)、[Spec Coding 规范驱动编程](./practices/spec-coding.md)、[Vibe Coding 实用技巧总结](./practices/the-cool-tricks-for-vibe-coding.md)：把提示词、权限、Spec、Git、多 Agent 和技术配图工作流串起来。
