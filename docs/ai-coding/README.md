...
head:
  - - meta
    - name: keywords
      content: AI编程,AI辅助编程,AI编程实战,AI编程技巧,AI编程面试题,AI编程工具,Claude Code,Claude Code教程,Claude Code使用技巧,Claude Code原理,CLAUDE.md,Claude Code Hooks,Auto Memory,Multi-Agent,Cursor,OpenAI Codex,Codex最佳实践,oh-my-pi,Trae,CLI vs IDE,Spec Coding,AI Skills,AI代码审查
  - - meta
    - property: og:title
...
5. [AI 编程必备 Skills 推荐](./practices/programmer-essential-skills.md)、[OpenAI Codex 最佳实践指南](./practices/codex-best-practices.md)、[Spec Coding 规范驱动编程](./practices/spec-coding.md)、[Vibe Coding 实用技巧总结](./practices/the-cool-tricks-for-vibe-coding.md)：把提示词、权限、Spec、Git 和多 Agent 工作流串起来。
